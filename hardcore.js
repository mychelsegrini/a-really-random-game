class Hardcore extends Phaser.Scene{ //Class that represents the game's hardcore mode.

    dialogueScene = -1; //Class property that represents the scene of the dialogue present in the method dialogue().

    constructor(){ //Constructor method.
        super({key: 'Hardcore'}) //Calls Phaser.Scene's constructor method.
    }
    ...
    animateSquare(){ //Animates the "space-time holes".
        ...
        this.square.setVelocityX(130 * (Math.round(Math.random()*2 - 1))); //Sets the x-component of the velocity as 0, -130 or +130.
        this.square.setVelocityY(130 * (Math.round(Math.random()*2 - 1))); //Sets the y-component of the velocity as 0, -130 or +130.
